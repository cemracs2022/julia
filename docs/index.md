...
└   fn = "/tmp/jl_6Qc6KV/build/rotation2d.gif"
```
...
```
 20.036419 seconds (439.17 k allocations: 166.505 MiB, 0.19% gc time, 1.06% compilation time)
...
```
  0.500370 seconds (8.28 k allocations: 208.557 MiB, 3.49% gc time)
...
─────────────────────────────────────────────────────────────────
x1   1.04647     0.0200825  52.11    <1e-72   1.00661    1.08633
x2  -0.416805    0.0898619  -4.64    <1e-04  -0.595156  -0.238454
x3  -0.0178584   0.0994554  -0.18    0.8579  -0.21525    0.179533
─────────────────────────────────────────────────────────────────
...
```
  3.313 ms (4 allocations: 16.00 MiB)
```
...
```
  2.420 ms (2 allocations: 8.00 MiB)
```
...
```
  913.169 μs (0 allocations: 0 bytes)
```
...
```
  54.671 ms (55 allocations: 64.00 MiB)
```
...
```
  22.674 ms (2 allocations: 96 bytes)
```
